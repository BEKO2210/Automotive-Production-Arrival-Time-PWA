    ...
    >
      ...
      <div className="flex justify-center items-center gap-1 md:gap-4 mb-8">
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-gray-500 text-[9px] mt-2 uppercase tracking-widest">
            Stunden
          </span>
        </div>

        {/* Trennzeichen */}
        <div className="text-xl md:text-5xl lg:text-6xl font-bold text-[#d5001c] pb-6 opacity-80 w-3 flex justify-center">
          :
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-[#d5001c] opacity-80 text-[9px] mt-2 uppercase tracking-widest">
            Sekunden
          </span>
        </div>
      </div>
